...
function Footer() {
    ...
    const { setShowProducts } = useContext(StoreContext);
    return (
        <>
                ...
                <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-16 pb-8">
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
                        <div className="lg:col-span-2">
                            ...
                            <div className="flex space-x-4">
                                ...
                                <a href="javascript:;"  className="w-10 h-10 bg-gray-800 hover:bg-blue-600 rounded-lg flex items-center justify-center transition-all duration-300 hover:scale-110 hover:shadow-lg group">
                        ...
                        <div>
                            ...
                            <ul className="space-y-3">
                                <li><Link to={'/contact'} className="text-gray-300 hover:text-white transition-colors duration-200 hover:translate-x-1 transform inline-block">Help Center</Link></li>
                            </ul>
                        </div>
                    </div>
                    ...
                    <div className="border-t border-gray-800 pt-8 flex flex-col md:flex-row items-center justify-between">
                        <p className="text-gray-400 text-sm mb-4 md:mb-0">
                            © 2025 Toyota. All rights reserved.
                        </p>
                        <div className="flex items-center space-x-6 text-sm text-gray-400">
                            ...
                            <div className="flex items-center space-x-1">
                                ...
                                <span>by <span className="font-semibold">JERALC SCOOTY</span></span>
                            </div>
                        </div>
                    </div>
                </div>

...
function Header({ setShowProducts, setShowService , setMenu, menu }:
  {
    menu:boolean,
    ...
    <header className='bg-white border-b-2 border-black/10' onMouseEnter={() => { setShowProducts(false), setShowService(false) }}>
      <nav className=''>
        <div className='flex justify-between mt-0.5 p-2 md:mx-5 md:p-5'>
          ...
          <svg className='w-3/5 mt-0.5 md:h-6 md:w-1/6 hover:cursor-pointer' onMouseEnter={() => { setShowProducts(false) }} xmlns="http://www.w3.org/2000/svg" width="136" height="24" viewBox="0 0 136 24"><path fill="none" d="M0 0h158v48H0V0z" />

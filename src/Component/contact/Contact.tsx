...
function Contact() {
    const { showProducts, menu, setMenu, load, pageLoad, setPageLoad, setHeaderLoad, setFooterLoad } = useContext(StoreContext);
                                ...
                                <div className="bg-gray-900 md:col-span-4 p-10 text-white">
                                    ...
                                    <div className="flex items-center mt-5">
                                        <svg className="h-6 mr-2 text-indigo-600" fill="currentColor" version="1.1" id="Capa_1"
                                            ...
                                            viewBox="0 0 60.002 60.002" style={{ background: 'new 0 0 60.002 60.002', fill: 'red' }} xmlSpace="preserve">
                                            <g>
                                    ...
                                    <div className="flex items-center mt-5">
                                        <svg className="h-8 mr-2 text-indigo-600" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
